(() => {
  ...
  const unitsPressure = document.getElementById('units-pressure');
  const unitsSprings = document.getElementById('units-springs');
  const unitsRideHeight = document.getElementById('units-rideheight');
  const unitsDownforce = document.getElementById('units-downforce');

  const result = document.getElementById('result');

  function generateText() {
    const pressureUnit = unitsPressure.options[unitsPressure.selectedIndex].text;
    const springsUnit = unitsSprings.options[unitsSprings.selectedIndex].text;
    const rideheightUnit = unitsRideHeight.options[unitsRideHeight.selectedIndex].text;
    const downforceUnit = unitsDownforce.options[unitsDownforce.selectedIndex].text;
