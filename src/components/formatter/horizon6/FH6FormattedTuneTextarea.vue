...
import fh6DiscordGenerator from './fh6-discord-generator';
import fh6RedditGenerator from './fh6-reddit-generator';
import { useFH6SetupForm } from './useFH6SetupForm';

const state = useFH6SetupForm();
...
const generator = computed(() => {
  if (selectedFormat.value === 'discord') return fh6DiscordGenerator;
  return fh6RedditGenerator;
});
