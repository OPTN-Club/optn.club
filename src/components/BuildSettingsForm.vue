...
import { BuildSettings, TransmissionUpgrade, TireCompound, RimStyleType } from '../lib/types';
...
<template>
  ...
  <section>
    ...
    <div class="row">
      ...
      <LimitedUpgradeSelect v-model="state.form.engine.ignition" label="ignition" no-street />
      ...
      <LimitedUpgradeSelect v-model="state.form.engine.turbo" label="Turbo" no-street />
      <LimitedUpgradeSelect v-model="state.form.engine.twinTurbo" label="Twin Turbo" no-street />
      ...
      <LimitedUpgradeSelect
        ...
        no-street
      />
      <LimitedUpgradeSelect v-model="state.form.engine.intercooler" label="Intercooler" no-street />
      <LimitedUpgradeSelect v-model="state.form.engine.oilCooling" label="Oil Coolling" no-street />
  ...
  <section>
    ...
    <div class="row">
      ...
      <UpgradeSelect v-model="state.form.platformAndHandling.frontArb" label="Front ARB" no-street />
  ...
  <section>
    ...
    <div class="row">
      <EnumSelect v-model="state.form.tiresAndRims.compound" label="Compound" :type="TireCompound" />
    </div>
